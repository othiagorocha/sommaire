...
export default async function SummaryPage(props: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div
      className='relative isolate min-h-screen bg-linear-to-b
          ...
          <div className='relative'>
            <div
              className='relative p-4 sm:p-6 lg:p-8 bg-white/80 backdrop-blur-md rounded-2xl
                            sm:rounded-3xl shadow-xl border border-rose-100/30 transition-all
                            duration-300 hover:shadow-2xl hover:bg-white/90 max-w-4xl mx-auto'>
              <div
                className='absolute inset-0 bg-linear-to-br from-rose-50/50 via-orange-50/30
