    ...
    <div className={cn("relative isolate")}>
      <div aria-hidden className='pointer-events-none absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl sm:-top-32'>
        <div
          ...
          className={cn(
            "relative left-[calc(50%-11rem)] aspect-1155/678 w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-linear-to-br from-emerald-500 via-teal-500 to-cyan-500 opacity-20 sm:left-[cal(50%-30rem)] sm:w-[72rem]",
            className
          )}
        />
      </div>
