          ...
          <div className='flex flex-col gap-2 min[400px]:flex-row justify-center'>
            <div>
              <Button
                ...
                variant='link'
                className={cn(
                  "w-full min-[400px]:w-auto bg-linear-to-r from-slate-900 to-rose-500 hover:from-rose-900 hover:to-slate-900",
                  "hover:text-white text-white transition-all duration-300 flex items-center justify-center"
                )}>
                <Link href='#pricing' className='flex justify-center items-center'>
